            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        @if(count($getRating) > 1)
                        <small class="pt-1">({{ count($getRating ?? '') }} Reviews)</small>
                        @else
                        <small class="pt-1">({{ count($getRating ?? '') }} Review)</small>
                        @endif
                    </div>
                    <h3 class="font-weight-semi-bold mb-4">${{ number_format($item['price'],2) }}</h3>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" class="form-control bg-secondary border-0 text-center" id="btnValue" value="1" name="qty">
                            <div class="input-group-btn">
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        ...
                        @if (!empty($getRating))
                        <a class="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-3">Reviews ({{ count($getRating) }})</a>
                        @else
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                 ...
                                 @foreach ($getRating as $rating)
                                    @if ($loop->first)
                                        <h4 class="mb-4">{{ count($getRating) }} review for "{{ $rating->product->product_name }}"</h4>    
                                    @endif
                                    <div class="media mb-4">
                                        <img src="{{ asset('assets/img/user.jpg') }}" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6>{{ $rating->user->name }}<small> - {{ Carbon\Carbon::parse($rating->created_at)->format('d M Y') }}
                                                {{-- <i>01 Jan 2045</i> --}}
                                            </small></h6>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex my-3">
                                        ...
                                        <div class="rating-css" style="margin-top: -19px;">
                                            <div class="star-icon">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="message" cols="30" rows="6" class="form-control" name="content"></textarea>
                                            @error('content')
	                                        <p class="error">{{ $message }}</p>
                                            @enderror
                                        </div>
    ...
    {{-- <script>
        $(document).ready(function () {
            $(".btn-minus").on('click', function (e) {
                e.preventDefault();
                var minusValue = $(this).val();
                $("#btnValue").innerText = minusValue;
            });
            $(".btn-minus").on('click', function (e) {
                e.preventDefault();
                var minusValue = $(this).val();
