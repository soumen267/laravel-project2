                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <button class="btn btn-danger btn-sm remove-from-cart remove" data-id="{{ $key }}"><i class="fa fa-trash-o"></i></button>
                                            </td>

                                            <td class="product-thumbnail">
                                                <a href="single-product.html"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="{{ asset('storage/'.$item['image']) }}"></a>
                                            </td>

                                            <td class="product-name">
                                                <a href="single-product.html">{{ substr($item['name'], 0, 12) }}</a>
                                            </td>
