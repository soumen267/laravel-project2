                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <form id="login-form-wrap" class="login collapse" method="post" action="">
                            ...
                            <form enctype="multipart/form-data" class="checkout" method="post" name="checkout" action="{{ route('checkout.store') }}">
                                @csrf
