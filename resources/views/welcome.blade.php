...
@section('content')
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item position-relative {{ ($index == 0) ? 'active':'' }}" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="{{ asset('storage/'.$row['image']) }}" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">{{ $row['title'] }}</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">{{ $row['subtitle'] }}</p>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            @php
                $tt = $item->product()->first();
            @endphp
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="{{ route('category.id', $item->id) }}">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            @if(!empty($tt->image))
                            <img class="img-fluid" src="{{ asset('storage/'.$tt->image) }}" alt="">
                            @else
                            <img class="img-fluid" src="" alt="Pic">
                            @endif                            
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>{{ $item['cat_name'] }}</h6>
                            <small class="text-body">{{ $item->product()->count() }} Products</small>
                        </div>
                    </div>
                </a>
            </div>
